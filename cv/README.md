...
## Technical Skills
* **Content Strategy:** API Documentation (REST/GraphQL), Information Architecture, Docs-as-Code, Developer Onboarding, Technical White Papers, Persona-based UX Writing.
* **Tooling:** Docusaurus, Confluence, GitHub Pages, Markdown, draw.io, Static Site Generators (SSG), Jira, Git.
...
* **Test Engineering:** Architected end-to-end automated testing frameworks for GraphQL back-ends using Ruby RSpec and Docker.
* **Process Automation:** Automated manual business processes, reducing offshore QE task cycles by 40% and improving data visualization through automated graphing tools.

### Quality Engineering Lead (Consultant) | Nike
**April 2018 – December 2018**

* **Global QA Strategy:** Orchestrated end-to-end QA for the SNKRS app across Web, iOS, and Android, ensuring 100% feature parity for global launch events.
...
* **Lead Engineer-In-Test** | SAY Media
